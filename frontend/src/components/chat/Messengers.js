...
const Messenger = () => {
  ...
  const getNewUsers = async ()=>{
    try{
        const response = await axios.get(path + "getNewUsers");
      ...
      {mobile ? (
          ...
          {!ActiveChat ? (
            <>
              <div className="chats">
                ...
                {newUsers.map((ele) => {
                  if(ele.username == UserDB.username){
                      console.log("return");
                      return <></>;
                  }
                  ...
                  return (
                    <Paper
                      onClick={() => {
                        navigate("/chat?user=" + ele.username);
                        setLoadChatAgain(!loadChatAgain);
                      }}
                    >
                      <div
        ...
        <>
         ...
         {newUsers.map((ele) => {
              ...
              const userDisplay = ele;
              return (
                <Paper onClick={() => navigate("/chat?user=" + ele.username)}>
                  <div
                    className={
                      ele._id == ActiveChat?._id
                        ? "chat-thumbnail Active-chat-thumbnail"
